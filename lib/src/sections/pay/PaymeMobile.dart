...
class PaymeMobile extends StatefulWidget {
  @override
  State<PaymeMobile> createState() => _PaymeMobileState();
}

class _PaymeMobileState extends State<PaymeMobile> {
  String token = "";
              ...
              child: Column(
                children: [
                  ClipRRect(
                      borderRadius: BorderRadius.all(Radius.circular(15)),
                      child:
                          Image.asset("assets/pay.jpg", width: width * 0.25)),
                  SizedBox(
                    height: height * 0.01,
                  ),
                  Row(
